            ...
            <form onSubmit={storeSkill} className='max-w-md mx-auto p-4 bg-white shadow-md rounded-sm'>
                <div className="space-y-6">
                    <div className="mb-4">
                        ...
                        <input name='name' value={formValues["name"]} onChange={onChange} className='border border-gray-300 text-sm rounded-md block w-full p-2' />
                    ...
                    <div className="mb-4">
                        ...
                        <input name='slug' value={formValues["slug"]} onChange={onChange} className='border border-gray-300 text-sm rounded-md block w-full p-2' />
